...
%%Designing Low Pass filter with pass band edge frequency=1700hz minimum stop band attenuation is 50dB Transition bandwidth is 0.5khz sampling frequency is 8khz
clear all;
close all;
 
clc;
fs=8000; %%sampling frequency
fp=1700; %%pass band edge frequency
